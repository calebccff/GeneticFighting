...
int GAME_TIME = 2400; //The time (in frames) between each call of the breed function
float BREED_PERCENT = 0.2; //How many of the top fighters are used to breed

//Neural net constants
final int NUM_INPUTS = 6; //Constants which define the neural network
